...
| 6 | `discovery.test.tsx` | `frontend/tests/discovery.test.tsx` | function | 14 |
| 7 | `config.ts` | `backend/src/config.ts` | file | 12 |
| 8 | `devDependencies` | `backend/package.json` | function | 11 |
...
### 3.1 frontend
**Nodes**: `277`  
**Files**: `.engine/memory/decisions.md`, `backend/package.json`, `backend/src/app.ts`, `backend/src/auth/auth.routes.ts`, `backend/src/auth/auth.service.ts`, `backend/src/booking/booking.routes.ts` +43 more
...
| `discovery.test.tsx` | function | `frontend/tests/discovery.test.tsx` | 14 |
| `config.ts` | file | `backend/src/config.ts` | 12 |
| `devDependencies` | function | `backend/package.json` | 11 |
| `booking.api.test.ts` | file | `backend/tests/booking.api.test.ts` | 11 |
